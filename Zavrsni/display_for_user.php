    ...
    <body>
        ...
        <form action="uredi_korisnika.php" method="post">
            ...
            if (isset($_SESSION['admin'])) {
                echo '<button name="uredi" class="button "type="submit" value="<?php echo $selektiraniUser ?>">Dodaj odsustvo</button>';
            }
            ?>
        </form>
        <form action="godisnji_odmor.php" method="post">
            <button name="god" class="button "type="submit">Godisnji</button>
        </form>
